...
public class PullCurrentTransform : MonoBehaviour {
	...
	void Start(){
		if(poiTransformFields.Count != 4 ){
			...
			poiTransformFields.Add(POI_ReferenceHub.Instance.POIEditWindow.Find("XPosField").GetComponent<InputField>());
			poiTransformFields.Add(POI_ReferenceHub.Instance.POIEditWindow.Find("YPosField").GetComponent<InputField>());
			poiTransformFields.Add(POI_ReferenceHub.Instance.POIEditWindow.Find("ZPosField").GetComponent<InputField>());
			poiTransformFields.Add(POI_ReferenceHub.Instance.POIEditWindow.Find("YRotField").GetComponent<InputField>());
		}
	}
