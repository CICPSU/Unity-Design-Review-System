...
public class S_CitySelected : MonoBehaviour {
	...
	public void clicked(){
		cityName = this.transform.Find("Text").GetComponent<UnityEngine.UI.Text>().text;
		...
		//update UI
		transform.parent.parent.parent.Find("CityOnDisplay").GetComponent<UnityEngine.UI.Text>().text = cityName;
