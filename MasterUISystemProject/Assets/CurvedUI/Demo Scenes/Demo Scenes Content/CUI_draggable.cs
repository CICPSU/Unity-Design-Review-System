...
namespace CurvedUI
{
    ...
    public class CUI_draggable : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        {
            if (this.GetComponentInParent<CurvedUISettings>().Controller == CurvedUISettings.CurvedUIController.MOUSE)
            {
            ...
            else if (this.GetComponentInParent<CurvedUISettings>().Controller == CurvedUISettings.CurvedUIController.GAZE)
            {
